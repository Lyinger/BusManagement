...
<html>
  <head>
    ...
    <title>My JSP 'ManageModifyStation.jsp' starting page</title>
  ...
  <body>
    ...
    <form action="/BusManage/manage/modifyStationSQL" method="post" onsubmit="return varify()">
    <div>
        <% String st = (String)request.getAttribute("station");%>
        <div style="float:right;margin-top:40px"><button class="btn btn-default" type="submit">确认修改</button></div>
        <div class="input-group input-group" style="float:left;width:60%;margin-left:100px;margin-top:40px">
        <span class="input-group-addon"><b>站点名称</b></span><input id="sname" name="stationName" type="text" class="form-control" value="<%=st%>">
        </div>
    </div>
    </form>
