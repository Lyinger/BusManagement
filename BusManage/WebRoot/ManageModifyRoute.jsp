...
<html>
  <head>
    ...
    <title>My JSP 'ManageModifyRoute.jsp' starting page</title>
  ...
  <body>
    ...
    <form action="/BusManage/manage/modifyRouteSQL">
    <% route rt = (route)request.getAttribute("routeInfo");%>
    <div style="float:left;width:70%;margin-top:10px;margin-left:60px">
      ...
      <div style="float:left">
        ...
        <span class="input-group-addon"><b>线路编号</b></span><input id="rnum" name="routeNum" type="text" class="form-control" value="<%=rt.getRnum()%>">
        </div>
        <div class="input-group input-group" style="margin-top:10px;margin-bottom:10px">
        ...
        <div class="input-group input-group" style="margin-top:10px;margin-bottom:10px">
        <span class="input-group-addon"><b>票价</b></span><input id="pri" name="price" type="text" class="form-control" value="<%=rt.getPrice()%>">
        </div>
        <div class="input-group input-group" style="margin-top:10px;margin-bottom:10px">
        <span class="input-group-addon"><b>始发时间</b></span><input id="stime" name="startTime" type="text" class="form-control" value="<%=rt.getStartTime()%>"/>
        </div>
        <div class="input-group input-group" style="margin-top:10px;margin-bottom:10px">
        <span class="input-group-addon"><b>末班时间</b></span><input id="ftime" name="finishTime" type="text" class="form-control" value="<%=rt.getFinishTime()%>"/>
        </div>
        <div class="input-group input-group" style="margin-top:10px;margin-bottom:10px">
        <span class="input-group-addon"><b>发车间隔</b></span><input id="intv" name="interval" type="text" class="form-control" value="<%=rt.getInterval()%>" />
        </div>
        <div class="input-group input-group" style="margin-top:10px;margin-bottom:10px">
        <span class="input-group-addon"><b>所经站点</b></span><textarea id="st" name="stations" class="form-control" style="height:80px"><%=rt.getStations()%></textarea>
        </div>
      </div>
     </div>
    </form>
